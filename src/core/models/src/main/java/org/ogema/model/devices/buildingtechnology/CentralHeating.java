 ...
 */
public interface CentralHeating extends PhysicalElement {
	/**
	...
	/**
	 * Stores total primary energy used, total heat energy
	 * should be stored on the {@link #heatGenerator() }
	 * 
	 * @return total primary energy used.
	 */
