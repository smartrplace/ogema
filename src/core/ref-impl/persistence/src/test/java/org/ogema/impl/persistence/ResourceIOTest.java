...
public class ResourceIOTest {
	...
	public Option[] configure() {
		return options(
				...
				CoreOptions.mavenBundle("com.fasterxml.jackson.core", "jackson-core", "2.9.9"),
				CoreOptions.mavenBundle("com.fasterxml.jackson.core", "jackson-annotations", "2.9.9"),
				CoreOptions.mavenBundle("com.fasterxml.jackson.core", "jackson-databind", "2.9.9"),
				CoreOptions.mavenBundle("com.fasterxml.jackson.module", "jackson-module-jaxb-annotations", "2.9.9"),
